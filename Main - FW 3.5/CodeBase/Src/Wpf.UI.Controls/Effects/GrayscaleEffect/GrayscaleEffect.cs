namespace EyeOpen.Wpf.UI.Controls
{
    ...
    {
        private static readonly PixelShader PixelShaderGrayEffect = 
            new PixelShader
                {
                    UriSource = new Uri(@"pack://application:,,,/EyeOpen.Wpf.UI.Controls;component/Effects/GrayscaleEffect/GrayscaleEffect.ps")
                };
        ...
        {
            PixelShader = PixelShaderGrayEffect;
